...
public class FeedbackActivity extends AppCompatActivity {
	...
	private HashMap<String, Object> feedback_ = new HashMap<>();
	...
	private DatabaseReference dbase = _firebase.getReference("feedback/");
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		feedback_container = (LinearLayout) findViewById(R.id.feedback_container);
		...
		send.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				feedback_.put("user", FirebaseAuth.getInstance().getCurrentUser().getEmail());
				feedback_.put("feedback", feed.getText().toString());
				dbase.push().updateChildren(feedback_);
				SketchwareUtil.showMessage(getApplicationContext(), "Thanks for the Feedback!...");
				finish();
			}
		});
	...
	private void initializeLogic() {
		_RippleEffect("Grey", send);
		_CardView("#ffffff", 5, 10, feedback_container);
	}
