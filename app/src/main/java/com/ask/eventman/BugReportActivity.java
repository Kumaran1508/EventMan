...
public class BugReportActivity extends AppCompatActivity {
	...
	private HashMap<String, Object> bug = new HashMap<>();
	...
	private DatabaseReference dbase = _firebase.getReference("bugs/");
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		send.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				bug.put("user", FirebaseAuth.getInstance().getCurrentUser().getEmail());
				bug.put("bug", feed.getText().toString());
				dbase.push().updateChildren(bug);
				SketchwareUtil.showMessage(getApplicationContext(), "Thanks for Reporting!...");
				finish();
			}
		});
